...
const handleSetLogOut=async()=>{
 ...
 await  toast.success("successfully loggged out")
  ...
  return (
   ...
   <div className="bg-white rounded-xl w-32 flex justify-center items-center gap-1">
   <LiaHomeSolid className="text-black" size={15} />
   <Link to={"/home"} className="hover:text-[#9299a4] text-black text-[13px]">Home</Link>
   ...
   {Capitalize(user?.email)}
    ...
    <div className="block xl:hidden lg:hidden md:hidden sm:block p-2 mt-16 ">
...
Account settings
   ...
   <li className="flex  items-center gap-1 hover:border-b-2" onClick={handleSetLogOut}>
    ...
    <div className="xl:w-5/6 border-2  bg-white md:p-3  md:mt-40 shadow-xl mx-auto xl:h-[500px]  xl:mt-32 mt-20 mb-12">

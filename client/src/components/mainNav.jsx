...
That's why we're dedicated to providing high-quality, natural body creams that moisturize, soothe, and protect your skin."
          ...
          <div className="relative group">
            <button
              ...
              className="border-2 p-2  xl:w-24 text-[12px]    rounded-lg border-[#891980] bg-[#891980] text-white shadow-lg hover:bg-white hover:text-[#891980]"
            >
              Contact us
            </button>
          </div>
          ...
          <div className="flex gap-4 ml-12 border border-[#891980] p-2 rounded-md">
            ...
            {openNavMenu && (
              <div className="w-40 md:block lg:block   bg-white border absolute xl:top-[72px] 2xl:top-[68px] p-3 pb-4 rounded-lg">
                <span

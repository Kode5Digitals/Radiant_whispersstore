...
const Banner = () => {
  ...
  return (
    ...
    <div className="mt-36 xl:mt-[74px] xl:h-[550px] bg-slate-600  lg:h-[500px] lg:mt-18 md:mt-[75px]  flex h-[300px]   sm:mt-36 " >
...
<div className="xl:w-3/5 bg-red-10 xl:mr-24 xl:mt-24 lg:mt-36  lg:mr-24  pl-8 pr-4 mt-20  w-1/2    sm:w-1/2 sm:pr-16 sm:mt-16 lg:w-3/5 md:w-3/5">
